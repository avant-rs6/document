...
class Builder
{
    ...
    protected function extractAnnotations()
    {
        foreach ($this->classes as $class) {
            ...
            // var_dump(!isset($classAnnotation['ApiTitle']));die;
            // 如果忽略
            if (isset($classAnnotation['ApiInternal']) || !isset($classAnnotation['ApiTitle'])) {
                continue;
            }
        ...
        $allClassMethodAnnotation = is_null($allClassMethodAnnotation) ? [] : $allClassMethodAnnotation;
